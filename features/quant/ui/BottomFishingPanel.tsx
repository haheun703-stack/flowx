  ...
  return (
    <div className="bg-white rounded-xl border border-[var(--border)] shadow-sm h-full">
      <div className="px-4 py-3 border-b border-[var(--border)]/50 flex items-center justify-between">
        <h3 className="text-[15px] font-bold text-[var(--text-primary)]">바닥잡이 레이더</h3>
        <span className="text-[9px] font-bold px-2 py-0.5 rounded-full bg-[#DBEAFE] text-[#2563EB]">
          COMING SOON
        </span>
      </div>
            ...
            >
              <div className="flex items-center justify-between mb-1">
                <div>
                  ...
                  <span className="text-[10px] text-[var(--text-muted)] ml-1">{c.ticker}</span>
                </div>
