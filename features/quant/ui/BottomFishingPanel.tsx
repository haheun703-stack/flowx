  ...
  return (
    <div className="bg-white rounded-xl border border-[var(--border)] shadow-sm h-full">
      <div className="px-4 py-3 border-b border-[var(--border)]/50 flex items-center justify-between">
        <h3 className="text-[17px] font-bold text-[#1A1A2E]">바닥잡이 레이더</h3>
        <span className="text-[12px] font-bold px-2 py-0.5 rounded-full bg-[#DBEAFE] text-[#2563EB]">
          COMING SOON
        </span>
      </div>

      <div className="p-4 space-y-3">
        <p className="text-[13px] font-bold text-[#1A1A2E] mb-2">
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-1">
                <div>
                  <span className="text-[14px] font-bold text-[#1A1A2E]">{c.name}</span>
                  <span className="text-[13px] text-[#9CA3AF] ml-1">{c.ticker}</span>
                </div>
                <span className="text-[13px] font-bold text-[#059669]">
                  반등확률 {c.rebound}%
                </span>
              </div>
              <div className="flex gap-3 text-[13px] text-[#6B7280]">
