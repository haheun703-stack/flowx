...
import { GRADE_STRONG_PICK } from '@/shared/constants/grades'

const GRADE_CONFIG: Record<SignalGrade, { label: string; color: string; bg: string; border: string }> = {
  STRONG_BUY: { label: GRADE_STRONG_PICK,    color: 'text-emerald-600', bg: 'bg-white', border: 'border-emerald-500/40' },
