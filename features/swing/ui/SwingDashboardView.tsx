...
export default function SwingDashboardView() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-6 pt-6 space-y-8">
      ...
      {/* ═══ 피보나치 눌림목 종목 ═══ */}
      {data.fib_stocks && data.fib_stocks.length > 0 && (
        <FibStocksPanel stocks={data.fib_stocks} />
      )}
...
function FibStocksPanel({ stocks }: { stocks: FibStock[] }) {
  ...
  return (
    <section>
      ...
      {/* 하단 범례 */}
      <div className="mt-4 rounded-xl p-3" style={{ backgroundColor: '#1A1A2E' }}>
