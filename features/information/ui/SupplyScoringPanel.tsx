  ...
  return (
    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
      ...
      <td className="py-3 px-2 text-right">
        ...
        {item.foreign_days !== 0 && (
          <div className="text-[10px] text-gray-400">{item.foreign_days > 0 ? '매수' : '매도'} {Math.abs(item.foreign_days)}일</div>
        )}
      </td>
      ...
      <td className="py-3 px-2 text-right">
        ...
        {item.inst_days !== 0 && (
          <div className="text-[10px] text-gray-400">{item.inst_days > 0 ? '매수' : '매도'} {Math.abs(item.inst_days)}일</div>
        )}
      </td>
